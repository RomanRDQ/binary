 ...
 */
function(e,t){"use strict";"function"==typeof define&&define.amd?define(t):"object"==typeof exports?module.exports=t():e.baguetteBox=t()}(this,(function(){"use strict";var e,t,n,r,i,o='<svg width="44" height="60"><polyline points="30 10 10 30 30 50" stroke="rgba(255,255,255,0.5)" stroke-width="4"stroke-linecap="butt" fill="none" stroke-linejoin="round"/></svg>',s='<svg width="44" height="60"><polyline points="14 10 34 30 14 50" stroke="rgba(255,255,255,0.5)" stroke-width="4"stroke-linecap="butt" fill="none" stroke-linejoin="round"/></svg>',a='<svg width="30" height="30"><g stroke="rgb(160,160,160)" stroke-width="4"><line x1="5" y1="5" x2="25" y2="25"/><line x1="5" y1="25" x2="25" y2="5"/></g></svg>',l={},u={captions:!0,buttons:"auto",fullScreen:!1,noScrollbars:!1,bodyClass:"baguetteBox-open",titleTag:!1,async:!1,preload:2,animation:"slideIn",afterShow:null,afterHide:null,onChange:null,overlayBackgroundColor:"rgba(0,0,0,.8)"},c={},d=[],f=0,p=!1,h={},g=!1,m=/.+\.(gif|jpe?g|png|webp)/i,v={},y=[],b=null,x=function(e){-1!==e.target.id.indexOf("baguette-img")&&H()},w=function(e){e.stopPropagation?e.stopPropagation():e.cancelBubble=!0,P()},C=function(e){e.stopPropagation?e.stopPropagation():e.cancelBubble=!0,M()},T=function(e){e.stopPropagation?e.stopPropagation():e.cancelBubble=!0,H()},E=function(e){h.count++,h.count>1&&(h.multitouch=!0),h.startX=e.changedTouches[0].pageX,h.startY=e.changedTouches[0].pageY},S=function(e){if(!g&&!h.multitouch){e.preventDefault?e.preventDefault():e.returnValue=!1;var t=e.touches[0]||e.changedTouches[0];t.pageX-h.startX>40?(g=!0,P()):t.pageX-h.startX<-40?(g=!0,M()):h.startY-t.pageY>100&&H()}},A=function(){h.count--,h.count<=0&&(h.multitouch=!1),g=!1},k=function(){A()},_=function(t){"block"===e.style.display&&e.contains&&!e.contains(t.target)&&(t.stopPropagation(),q())};function N(e){if(v.hasOwnProperty(e)){var t=v[e].galleries;[].forEach.call(t,(function(e){[].forEach.call(e,(function(e){z(e.imageElement,"click",e.eventHandler)})),d===e&&(d=[])})),delete v[e]}}function D(e){switch(e.keyCode){case 37:P();break;case 39:M();break;case 27:H();break;case 36:!function(e){e&&e.preventDefault();B(0)}(e);break;case 35:!function(e){e&&e.preventDefault();B(d.length-1)}(e)}}function L(i,o){if(d!==i){for(d=i,function(i){i||(i={});for(var o in u)l[o]=u[o],void 0!==i[o]&&(l[o]=i[o]);t.style.transition=t.style.webkitTransition="fadeIn"===l.animation?"opacity .4s ease":"slideIn"===l.animation?"":"none","auto"!==l.buttons||!("ontouchstart"in window)&&1!==d.length||(l.buttons=!1);n.style.display=r.style.display=l.buttons?"":"none";try{e.style.backgroundColor=l.overlayBackgroundColor}catch(e){}}(o);t.firstChild;)t.removeChild(t.firstChild);y.length=0;for(var s,a=[],c=[],f=0;f<i.length;f++)(s=X("div")).className="full-image",s.id="baguette-img-"+f,y.push(s),a.push("baguetteBox-figure-"+f),c.push("baguetteBox-figcaption-"+f),t.appendChild(y[f]);e.setAttribute("aria-labelledby",a.join(" ")),e.setAttribute("aria-describedby",c.join(" "))}}function j(t){l.noScrollbars&&(document.documentElement.style.overflowY="hidden",document.body.style.overflowY="scroll"),"block"!==e.style.display&&($(document,"keydown",D),h={count:0,startX:null,startY:null},O(f=t,(function(){F(f),W(f)})),R(),e.style.display="block",l.fullScreen&&(e.requestFullscreen?e.requestFullscreen():e.webkitRequestFullscreen?e.webkitRequestFullscreen():e.mozRequestFullScreen&&e.mozRequestFullScreen()),setTimeout((function(){e.className="visible",l.bodyClass&&document.body.classList&&document.body.classList.add(l.bodyClass),l.afterShow&&l.afterShow()}),50),l.onChange&&l.onChange(f,y.length),b=document.activeElement,q(),p=!0)}function q(){l.buttons?n.focus():i.focus()}function H(){l.noScrollbars&&(document.documentElement.style.overflowY="auto",document.body.style.overflowY="auto"),"none"!==e.style.display&&(z(document,"keydown",D),e.className="",setTimeout((function(){e.style.display="none",document.fullscreen&&(document.exitFullscreen?document.exitFullscreen():document.mozCancelFullScreen?document.mozCancelFullScreen():document.webkitExitFullscreen&&document.webkitExitFullscreen()),l.bodyClass&&document.body.classList&&document.body.classList.remove(l.bodyClass),l.afterHide&&l.afterHide(),b&&b.focus(),p=!1}),500))}function O(e,t){var n=y[e],r=d[e];if(void 0!==n&&void 0!==r)if(n.getElementsByTagName("img")[0])t&&t();else{var i=r.imageElement,o=i.getElementsByTagName("img")[0],s="function"==typeof l.captions?l.captions.call(d,i):i.getAttribute("data-caption")||i.title,a=function(e){var t=e.href;if(e.dataset){var n=[];for(var r in e.dataset)"at-"!==r.substring(0,3)||isNaN(r.substring(3))||(n[r.replace("at-","")]=e.dataset[r]);for(var i=Object.keys(n).sort((function(e,t){return parseInt(e,10)<parseInt(t,10)?-1:1})),o=window.innerWidth*window.devicePixelRatio,s=0;s<i.length-1&&i[s]<o;)s++;t=n[i[s]]||t}return t}(i),u=X("figure");if(u.id="baguetteBox-figure-"+e,u.innerHTML='<div class="baguetteBox-spinner"><div class="baguetteBox-double-bounce1"></div><div class="baguetteBox-double-bounce2"></div></div>',l.captions&&s){var c=X("figcaption");c.id="baguetteBox-figcaption-"+e,c.innerHTML=s,u.appendChild(c)}n.appendChild(u);var f=X("img");f.onload=function(){var n=document.querySelector("#baguette-img-"+e+" .baguetteBox-spinner");u.removeChild(n),!l.async&&t&&t()},f.setAttribute("src",a),f.alt=o&&o.alt||"",l.titleTag&&s&&(f.title=s),u.appendChild(f),l.async&&t&&t()}}function M(){return B(f+1)}function P(){return B(f-1)}function B(e,t){return!p&&e>=0&&e<t.length?(L(t,l),j(e),!0):e<0?(l.animation&&I("left"),!1):e>=y.length?(l.animation&&I("right"),!1):(O(f=e,(function(){F(f),W(f)})),R(),l.onChange&&l.onChange(f,y.length),!0)}function I(e){t.className="bounce-from-"+e,setTimeout((function(){t.className=""}),400)}function R(){var e=100*-f+"%";"fadeIn"===l.animation?(t.style.opacity=0,setTimeout((function(){c.transforms?t.style.transform=t.style.webkitTransform="translate3d("+e+",0,0)":t.style.left=e,t.style.opacity=1}),400)):c.transforms?t.style.transform=t.style.webkitTransform="translate3d("+e+",0,0)":t.style.left=e}function F(e){e-f>=l.preload||O(e+1,(function(){F(e+1)}))}function W(e){f-e>=l.preload||O(e-1,(function(){W(e-1)}))}function $(e,t,n,r){e.addEventListener?e.addEventListener(t,n,r):e.attachEvent("on"+t,(function(e){(e=e||window.event).target=e.target||e.srcElement,n(e)}))}function z(e,t,n,r){e.removeEventListener?e.removeEventListener(t,n,r):e.detachEvent("on"+t,n)}function U(e){return document.getElementById(e)}function X(e){return document.createElement(e)}return[].forEach||(Array.prototype.forEach=function(e,t){for(var n=0;n<this.length;n++)e.call(t,this[n],n,this)}),[].filter||(Array.prototype.filter=function(e,t,n,r,i){for(n=this,r=[],i=0;i<n.length;i++)e.call(t,n[i],i,n)&&r.push(n[i]);return r}),{run:function(l,u){var d;return c.transforms=void 0!==(d=X("div")).style.perspective||void 0!==d.style.webkitPerspective,c.svg=function(){var e=X("div");return e.innerHTML="<svg/>","http://www.w3.org/2000/svg"===(e.firstChild&&e.firstChild.namespaceURI)}(),c.passiveEvents=function(){var e=!1;try{var t=Object.defineProperty({},"passive",{get:function(){e=!0}});window.addEventListener("test",null,t)}catch(e){}return e}(),function(){if(e=U("baguetteBox-overlay"))return t=U("baguetteBox-slider"),n=U("previous-button"),r=U("next-button"),void(i=U("close-button"));(e=X("div")).setAttribute("role","dialog"),e.id="baguetteBox-overlay",document.getElementsByTagName("body")[0].appendChild(e),(t=X("div")).id="baguetteBox-slider",e.appendChild(t),(n=X("button")).setAttribute("type","button"),n.id="previous-button",n.setAttribute("aria-label","Previous"),n.innerHTML=c.svg?o:"&lt;",e.appendChild(n),(r=X("button")).setAttribute("type","button"),r.id="next-button",r.setAttribute("aria-label","Next"),r.innerHTML=c.svg?s:"&gt;",e.appendChild(r),(i=X("button")).setAttribute("type","button"),i.id="close-button",i.setAttribute("aria-label","Close"),i.innerHTML=c.svg?a:"&times;",e.appendChild(i),n.className=r.className=i.className="baguetteBox-button",function(){var o=c.passiveEvents?{passive:!0}:null;$(e,"click",x),$(n,"click",w),$(r,"click",C),$(i,"click",T),$(t,"contextmenu",k),$(e,"touchstart",E,o),$(e,"touchmove",S,o),$(e,"touchend",A),$(document,"focus",_,!0)}()}(),N(l),function(e,t){var n=document.querySelectorAll(e),r={galleries:[],nodeList:n};return v[e]=r,[].forEach.call(n,(function(e){t&&t.filter&&(m=t.filter);var n=[];if(n="A"===e.tagName?[e]:e.getElementsByTagName("a"),0!==(n=[].filter.call(n,(function(e){if(-1===e.className.indexOf(t&&t.ignoreClass))return m.test(e.href)}))).length){var i=[];[].forEach.call(n,(function(e,n){var r=function(e){e.preventDefault?e.preventDefault():e.returnValue=!1,L(i,t),j(n)},o={eventHandler:r,imageElement:e};$(e,"click",r),i.push(o)})),r.galleries.push(i)}})),r.galleries}(l,u)},show:B,showNext:M,showPrevious:P,hide:H,destroy:function(){!function(){var o=c.passiveEvents?{passive:!0}:null;z(e,"click",x),z(n,"click",w),z(r,"click",C),z(i,"click",T),z(t,"contextmenu",k),z(e,"touchstart",E,o),z(e,"touchmove",S,o),z(e,"touchend",A),z(document,"focus",_,!0)}(),function(){for(var e in v)v.hasOwnProperty(e)&&N(e)}(),z(document,"keydown",D),document.getElementsByTagName("body")[0].removeChild(document.getElementById("baguetteBox-overlay")),v={},d=[],f=0}}}));